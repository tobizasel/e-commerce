    ...
    <div className="contador">
      <div className="contador__container">
        ...
        <div className="contador__contador">
          <button className="contador__iconos" onClick={handleRestar}>
            <i class="fa-solid fa-circle-minus"></i>
          </button>
          <span className="contador__cuenta">{cuenta}</span>
          <button className="contador__iconos" onClick={handleSumar}>
        ...
        <button
          type="button"
          className="btn btn-outline-primary contador__boton"
          onClick={handleReset}
        >
          Agregar al carrito
        </button>
